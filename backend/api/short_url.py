#  реализация модуля для получения коротких ссылок pip install short_utl
alp = 'mn6j2c4rv8bpygASADAFAFASJAFHIEUFLKJSAHFKLw95z7hsdaetxuk3fq'
DEFAULT_ALPHABET = alp + alp.upper()
DEFAULT_BLOCK_SIZE = 36
MIN_LENGTH = 5
